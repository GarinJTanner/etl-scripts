...
write-output "insert into locations (latitude,longitude,location) VALUES ">C:\Users\...\...\output\shakeshack.sql
...
write-output "('$latitude','$longitude','$location')," >>C:\Users\...\...output\shakeshack.sql
